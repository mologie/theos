...
THEOS_FRAMEWORKS_PATH := $(THEOS)/frameworks
THEOS_MODULE_PATH := $(THEOS)/mod
export THEOS THEOS_BIN_PATH THEOS_MAKE_PATH THEOS_LIBRARY_PATH THEOS_INCLUDE_PATH THEOS_FRAMEWORKS_PATH
...
_THEOS_INTERNAL_LDFLAGS = $(if $(_THEOS_TARGET_HAS_LIBRARY_PATH),-L$(THEOS_TARGET_LIBRARY_PATH) )-L$(THEOS_LIBRARY_PATH) -F$(THEOS_FRAMEWORKS_PATH)
...
_THEOS_INTERNAL_CFLAGS = -DTARGET_$(_THEOS_TARGET_NAME_DEFINE)=1 -F$(THEOS_FRAMEWORKS_PATH) $(OPTFLAG) -Wall
