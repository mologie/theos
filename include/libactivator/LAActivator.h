...
- (NSString *)configurationViewControllerClassNameForEventWithName:(NSString *)eventName bundle:(NSBundle **)outBundle;
...
- (NSString *)configurationViewControllerClassNameForListenerWithName:(NSString *)listenerName bundle:(NSBundle **)outBundle;
- (Class)configurationViewControllerClassForListenerWithName:(NSString *)listenerName;
